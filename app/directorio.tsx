...
import { Avatar, Body, Card, Field, Label, Muted } from "../components/ui";
import { formatCumple } from "../lib/date";
...
// Directorio de la congregación: nombre, cumpleaños y contacto (llamar / WhatsApp).
// Visible para todo miembro activo (RLS de la vista `directorio`).
        ...
        <View className="flex-1">
          ...
          {p.fecha_nacimiento ? (
            <View className="mt-0.5 flex-row items-center gap-1">
              <Ionicons name="gift-outline" size={13} color={colors.outline} />
              <Muted className="capitalize">{formatCumple(p.fecha_nacimiento)}</Muted>
            </View>
          ) : null}
        </View>
        {p.telefono ? (
